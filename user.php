...
<!-- Page Content -->
  <div class="container">
    ...
    <button type="button" id="add_user" class="btn btn-info btn-sm mb-3">Add New Patient</button>

    <!-- Users DataTable -->
    <div class="card mx-auto mb-4 border-info">
      <div class="card-header bg-info text-white">Patient Table</div>
      <div class="card-body">
      ...
      <div class="modal-content">
        ...
        <div class="container">
          <div class="card border-info">
            <h5 class="card-header bg-info text-white">Update Patient Profile</h5>
            <div class="modal-body">
